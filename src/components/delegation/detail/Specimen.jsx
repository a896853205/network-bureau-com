    ...
    if (enterpriseDelegationUuid) {
      (async () => {
        ...
        if (delegationSpecimen) {
          ...
          if (delegationSpecimen.failText) {
            setFailText(delegationSpecimen.failText);
          }

          delete delegationSpecimen.status;
          delete delegationSpecimen.statusText;
          delete delegationSpecimen.failText;
    ...
    form.validateFields(async (err, value) => {
      if (enterpriseDelegationUuid) {
        if (!err) {
          ...
          const res = await proxyFetch(SAVE_DELEGATION_SPECIMEN, value);
