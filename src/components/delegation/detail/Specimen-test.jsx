...
// 样式
import '@/style/home/delegation/specimen.styl';
    ...
    if (enterpriseDelegationUuid) {
      (async () => {
        ...
        if (delegationSpecimen) {
          // 数据处理
          // 时间处理
          if (delegationSpecimen.devStartTime) {
            delegationSpecimen.devStartTime = moment(
              delegationSpecimen.devStartTime
            );
          }

          if (delegationSpecimen.failManagerText) {
            setFailManagerText(delegationSpecimen.failManagerText);
          }

          delete delegationSpecimen.managerStatus;
          delete delegationSpecimen.failManagerText;

          setFieldsValue(delegationSpecimen);
        }
    ...
    form.validateFields(async (err, value) => {
      if (enterpriseDelegationUuid) {
        if (!err) {
          ...
          const res = await proxyFetch(SAVE_TEST_DELEGATION_SPECIMEN, value);
