...
import {
  ...
  SAVE_TEST_REGISTRATION_SPECIMEN
    ...
    if (enterpriseRegistrationUuid) {
      (async () => {
        ...
        if (registrationSpecimen) {
          ...
          if (registrationSpecimen.failManagerText) {
            setFailManagerText(registrationSpecimen.failManagerText);
          }

          delete registrationSpecimen.managerStatus;
          delete registrationSpecimen.failManagerText;
    ...
    form.validateFields(async (err, value) => {
      if (enterpriseRegistrationUuid) {
        if (!err) {
          ...
          const res = await proxyFetch(SAVE_TEST_REGISTRATION_SPECIMEN, value);
